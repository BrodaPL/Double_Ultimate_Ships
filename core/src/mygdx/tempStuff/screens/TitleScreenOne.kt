...
class TitleScreenOne(val _game: Game, val _skin: Skin) : Screen {
    ...
    internal val game: Game = _game
    internal val skin: Skin = _skin
...
//        TODO("not implemented") //To change body of created functions use File | Settings | File Templates.
    ...
    private fun createGameScreenGuiButton(): TextButton {
        val guiTestBtn = TextButton("Gui Test", skin)
        guiTestBtn.setWidth(Gdx.graphics.getWidth() / 2f)
        guiTestBtn.setPosition(
            Gdx.graphics.getWidth() / 2 - guiTestBtn.getWidth() / 2,
            Gdx.graphics.getHeight() / 1.8f - guiTestBtn.getHeight() / 1.8f
        )
    ...
    private fun createPlayButton(): TextButton {
        val playBtn = TextButton("Animation test", skin)
        playBtn.setWidth(Gdx.graphics.getWidth() / 2f)
        playBtn.setPosition(
            Gdx.graphics.getWidth() / 2 - playBtn.getWidth() / 2,
    ...
    private fun createTestingOneButton(): TextButton {
        val testOneBtn = TextButton("Features test 1", skin)
        testOneBtn.setWidth(Gdx.graphics.getWidth() / 2f)
        testOneBtn.setPosition(
            Gdx.graphics.getWidth() / 2 - testOneBtn.getWidth() / 2,
            Gdx.graphics.getHeight() / 2.5f - testOneBtn.getHeight() / 2
        )
    ...
    private fun createTestingTwoButton(): TextButton {
        val testTwoBtn = TextButton("Features test 2", skin)
        testTwoBtn.setWidth(Gdx.graphics.getWidth() / 2f)
        testTwoBtn.setPosition(
            Gdx.graphics.getWidth() / 2 - testTwoBtn.getWidth() / 2,
            Gdx.graphics.getHeight() / 3 - testTwoBtn.getHeight() / 2
        )
    ...
    private fun createOptionsButton(): TextButton {
        val optBtn = TextButton("Options and Shader test", skin)
        optBtn.setWidth(Gdx.graphics.getWidth() / 2f)
        optBtn.setPosition(
            Gdx.graphics.getWidth() / 2 - optBtn.getWidth() / 2,
            Gdx.graphics.getHeight() / 4 - optBtn.getHeight() / 2
        )
